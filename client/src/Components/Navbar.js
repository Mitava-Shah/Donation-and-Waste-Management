          ...
          <nav className="  mx-auto">
            <div className="flex flex-wrap items-center justify-between mx-[10px] p-[8px] sm:p-[10px] md:p-[12px] lg:p-[16px]">
              ...
              <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                ...
                <div className={`z-50 ${isUserProfileOpen ? 'block' : 'hidden'} my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute top-16 right-[3rem]`}>
                  {
          ...
          <div className='p-0 m-0 box-border bg-blue-950 '>
            <nav className=" mx-auto">
              <div className="flex flex-wrap items-center justify-between mx-[10px] p-[8px] sm:p-[10px] md:p-[12px] lg:p-[16px]">
               ...
               <div className='flex'>
               <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                  <button type="button" className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" onClick={toggleUserProfile}>
                    <span className="sr-only">Open user menu</span>
                    <img className="w-8 h-8 rounded-full" src={Profile} alt="user photo" />
                  </button>
                  <div className={`z-50 ${isUserProfileOpen ? 'block' : 'hidden'} my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600 absolute top-16 right-[3rem]`}>
                    ...
                    <ul className="py-2" aria-labelledby="user-menu-button">
                      <li>
                        {DonorLogin === true && (
                          <Link to="/donorprofile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">My Profile</Link>
                        )}
                        {AgentLogin === true && (
                          <Link to="/agentprofile" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">My Profile</Link>
                        )}
                      </li>
                      <li>
                        {AgentLogin === true && (
                          <Link to="/agentpanel" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</Link>
                        )}
                        {AdminLogin === true && (
                          <Link to="/adminpanel" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</Link>
                        )}
                        {DonorLogin === true && (
                          <Link to="/donorpanel" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Dashboard</Link>
                        )}
                      </li>

                      <li>
                        <a onClick={(e) => {
                          e.preventDefault(); handleAgentLogout(); handleDonorLogout(); handleAdminLogout();
                        }} href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Log out</a>
                      </li>
                    </ul>
                  </div>
                  <button type="button" className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" onClick={toggleMenu}>
