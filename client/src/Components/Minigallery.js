...
const Minigallery = () => {
    ...
    return (
        <>
            <div className='bg-gray-200 pb-[10px]'>
                <div className=' flex text-black pl-[10px]  h-[30px] p-0 m-0 items-center font-serif border-l-8 border-blue-950 container mx-auto '>
                    <p className='font-semibold  sm:text-[25px] text-[16px] text-blue-950'>GALLERY</p>
                </div>
                <p className='text-gray-600 pl-[20px] mt-[10px] font-semibold container mx-auto'>We have delivered <span className='text-gray-900 font-bold'>Wastage </span>or<span className='text-gray-900 font-bold'> Donations </span>to needy people.</p>
