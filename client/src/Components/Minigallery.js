            ...
            <div className='bg-gray-200 pb-[10px] pt-[10px]'>
                ...
                <div className=" mt-8 mb-4">
                    <div className=" px-4 justify-center items-center " >
                        <div className=" lg:mx-[10rem]  md:mx-[8rem] sm:mx-[5rem] mx-[3rem] mt-[4rem] lg:gap-y-8 md:gap-x-8 sm:gap-10 gap-8 pb-8 grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 justify-center  ">
                            {images.map((a) =>
                            ...
                            <p className=' text-blue-600 font-sans font-base text-[20px] p-[5px] rounded   '><Link className='hover:text-blue-700 hover:underline' to="/Gallery">View more</Link></p>
                        </div>
