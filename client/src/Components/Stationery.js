            ...
            <form className="w-full max-w-lg border-4 rounded-md py-[5px] px-[20px] mx-1 bg-gray-200" onSubmit={handleSubmit}>
                ...
                <div className="mb-[5px]">
                    <label className="block text-gray-700 text-sm font-semibold mb-1" htmlFor="footwearType">
                        Stationery Type<span className='text-red-500 ml-1'>*</span>
                    </label>
                    <input
                ...
                <div className="pl-5 pt-[5px] mx-2 font-sans text-xs">
                    <ol className="list-decimal ">
                        ...
                        <li className="mb-1 text-gray-700">Please ensure that the stationery items are in usable condition.</li>
                        <li className="mb-1 text-gray-700">We accept donations of new and gently used stationery items.</li>
                        <li className="mb-1 text-gray-700">Stationery items should be neatly packed and labeled, if possible.</li>
                    </ol>
                </div>
            </form>
        </div>
