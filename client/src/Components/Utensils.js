...
const Utensilsform = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!donationtype.trim()) {
            newErrors.donationtype = 'Footwear Type is required';
            hasErrors = true;
        }
        ...
        try {
            const response = await axios.post('http://localhost:3000/donate/donation', { donationtype, quantity, contactno, addresstocollect, message, email, username, area, condition });
    ...
    return (
        <div className="flex justify-center items-center h-screen m-4">
            <form className="w-full max-w-lg border-4 rounded-md py-[5px] px-[20px] mx-1 bg-gray-200" onSubmit={handleSubmit}>
                ...
                <div className="mb-2">
                    <label className="block text-gray-700 text-sm font-semibold mb-1" htmlFor="utensilType">
                        Utensil Name<span className='text-red-500 ml-1'>*</span>
                    </label>
                    <input
                ...
                <div className="pl-5 pt-[5px] mx-2  font-sans text-xs">
                    <ol className="list-decimal ">
                        ...
                        <li className="mb-1 text-gray-700">Please ensure that utensils are clean and in good condition.</li>
                        <li className="mb-1 text-gray-700">We accept a variety of utensils, including pots, pans, plates, and cutlery.</li>
                        <li className="mb-1 text-gray-700">Utensils must not be broken or damaged.</li>
                        <li className="mb-1 text-gray-700">We appreciate donations of sets or individual pieces.</li>
                        <li className="mb-1 text-gray-700">Please pack the utensils securely to prevent damage during transport.</li>
                    </ol>
                </div>
            </form>
        </div>
