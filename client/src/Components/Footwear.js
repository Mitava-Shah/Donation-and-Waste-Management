...
const Footwearform = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!area.trim()) {
            newErrors.area = 'Condition is required';
            hasErrors = true;
        }
            ...
            <form className="w-full max-w-lg border-4 rounded-md py-[5px] px-[20px] mx-1 bg-gray-200" onSubmit={handleSubmit}>
                ...
                <div className="mb-[5px]">
                    <label className="block text-gray-700 text-sm font-semibold mb-1" htmlFor="footwearType">
                        Footwear Type<span className='text-red-500 ml-1'>*</span>
                    </label>
                    <input
                ...
                <div className='flex justify-between lg:flex-row flex-col lg:gap-4'>
                    <div className="mb-[5px]">
                        <label className="block text-gray-700 text-sm font-semibold mb-1" htmlFor="quantity">
                            Quantity(in pairs)<span className='text-red-500 ml-1'>*</span>
                        </label>
                        <input
                ...
                <div className="pl-5 pt-[5px] mx-2  font-sans text-xs">
                    <ol className="list-decimal ">
                        ...
                        <li className="mb-1 text-gray-700">Always donate clean footwear.</li>
                        <li className="mb-1 text-gray-700">Avoid donating footwear that is broken or damaged.</li>
                        <li className="mb-1 text-gray-700">Donate Any Size Available</li>
                    </ol>
                </div>
            </form>
        </div>
