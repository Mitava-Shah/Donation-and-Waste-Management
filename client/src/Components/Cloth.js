...
const Clothesform = ({ onClose }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!donationtype.trim()) {
            newErrors.donationtype = 'Cloth Type is required';
            hasErrors = true;
        }
        ...
        // Clear all errors when submission is successful
        setErrors({});
       
        try {
            const response = await axios.post('http://localhost:3000/donate/donation', { donationtype, quantity, contactno, addresstocollect, message, email, username, condition,area });
    ...
    const handleChange = () => {
        ...
        if (area.trim()) { // Validation for new field
            delete errors.area;
        }
    }
    const handleClear = () => {
                ...
                <form className="w-full max-w-lg border-4 rounded-md py-[5px] px-[20px] mx-1 bg-gray-200" onSubmit={handleSubmit}>
                    ...
                    <div className="mb-[5px]">
                        <label className="block text-gray-700 text-sm font-semibold font-sans mb-1" htmlFor="clothType">
                            Cloth Type<span className='text-red-500 ml-1'>*</span>
                        </label>
                        <input
                    ...
                    <div className='flex justify-between lg:flex-row flex-col lg:gap-4'>
                        <div className="mb-[5px]">
                            <label className="block text-gray-700 text-sm font-semibold font-sans mb-1" htmlFor="quantity">
                                Quantity(per piece)<span className='text-red-500 ml-1'>*</span>
                            </label>
                            <input
                        ...
                        <div className="mb-[5px]">
                            <label className="block text-gray-700 text-sm font-semibold font-sans mb-1" htmlFor="quality">
                                Condition<span className='text-red-500 ml-1'>*</span>
                            </label>
                            <select
                                className="shadow capitalize appearance-none border rounded lg:w-[5.5cm] w-full py-1 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                id="condition"
                                name="condition"
                                value={condition}
                            ...
                            {errors.condition && <p className="text-red-500 text-xs italic">{errors.condition}</p>}
                    ...
                    <div className="mb-[5px]">
                        <label className="block text-gray-700 text-sm font-semibold font-sans mb-1" htmlFor="note">
                    ...
                    <div className="pl-5 pt-[5px] mx-2  font-sans text-xs">
                        <ol className="list-decimal ">
                            ...
                            <li className="mb-1 text-gray-700">Don’t donate Worn-out Clothes.</li>
                            <li className="mb-1 text-gray-700">Donate Clean Clothes.</li>
                            <li className="mb-1 text-gray-700">Don't donate Undergarments.</li>
                            <li className="mb-1 text-gray-700">Sort the clothes into separate bags or boxes.</li>
                        </ol>
                    </div>
                </form>
            </div>
